...
aws cloudformation create-stack --stack-name aws-workshop-with-nobl9 --template-body file://cloudfront-s3-website.yaml --enable-termination-protection
```
...
```
### DO NOT FORGET TO CHANGE THE STACK NAME
aws cloudformation create-stack --stack-name aws-modernization-with-nobl9-pipeline --template-body file://pipeline.yaml --capabilities CAPABILITY_NAMED_IAM --enable-termination-protection
```
